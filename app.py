...
# RSI Calculation Function (ပိုမိုတိကျသော ဗားရှင်း)
...
try:
    # BTC Data ကို ၅ ရက်စာ ဆွဲယူခြင်း (Data ပိုစုံအောင်)
    ...
    if not df.empty and len(df) > 20:
        ...
        st.warning("ဒေတာအလုံအလောက် မရသေးပါ။ ခဏစောင့်ပေးပါ...")

except Exception as e:
    st.error(f"ချိတ်ဆက်မှု အဆင်မပြေသေးပါ။ ပြန်ပွင့်လာပါလိမ့်မည်။")
